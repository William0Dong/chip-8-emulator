...
// Every row looks like the corresponding number in binary
...
// Copying the character set to the start of memory
...
// Loading the game at the start of the proper address and changing the program counter to start reading from there
...
// Executing the opcodes that start with 8
...
// Waiting for a keypress to return it
...
// Executing the opcodes that start with F
...
// Executing more opcodes
static void chip8_exec_extended(struct chip8* chip8, unsigned short opcode)
{
    // Getting different parts of opcodes
    // nnn/addr is the lowest 12 bits of the instruction
    // n/nibble is the lowest 4 bits of the instruction
    // x is the lower 4 bits of the high byte of the instruction
    // y is the upper 4 bits of the low byte of the instruction
    // kk/byte is the lowest 8 bits of the instruction
...
// Executing first two opcodes and then checking for the rest
